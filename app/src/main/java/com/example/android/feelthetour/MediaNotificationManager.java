...
import com.example.android.feelthetour.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "com.example.android.feelthetour.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "com.example.android.feelthetour.pause";
    public static final String ACTION_PLAY = "com.example.android.feelthetour.play";
    public static final String ACTION_PREV = "com.example.android.feelthetour.prev";
    public static final String ACTION_NEXT = "com.example.android.feelthetour.next";
    public static final String ACTION_STOP = "com.example.android.feelthetour.stop";
    public static final String ACTION_STOP_CASTING = "com.example.android.feelthetour.stop_cast";
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        Intent openUI = new Intent(mService, WelcomeActivity.class);
        openUI.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        openUI.putExtra(WelcomeActivity.EXTRA_START_FULLSCREEN, true);
        if (description != null) {
            openUI.putExtra(WelcomeActivity.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
    ...
    private int addActions(final NotificationCompat.Builder notificationBuilder) {
        ...
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING) {
            ...
            icon = R.drawable.feelthetour_ic_pause_white_24dp;
            intent = mPauseIntent;
        } else {
            label = mService.getString(R.string.label_play);
            icon = R.drawable.feelthetour_ic_play_arrow_white_24dp;
            intent = mPlayIntent;
        }
