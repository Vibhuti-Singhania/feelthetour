...
package com.example.android.feelthetour.playback;
...
import com.example.android.feelthetour.MusicService;
import com.example.android.feelthetour.model.MusicProvider;
import com.example.android.feelthetour.model.MusicProviderSource;
import com.example.android.feelthetour.utils.LogHelper;
import com.example.android.feelthetour.utils.MediaIDHelper;
...
public final class LocalPlayback implements Playback {
    ...
    public LocalPlayback(Context context, MusicProvider musicProvider) {
        ...
        this.mWifiLock =
                ((WifiManager) applicationContext.getSystemService(Context.WIFI_SERVICE))
                        .createWifiLock(WifiManager.WIFI_MODE_FULL, "feelthetour_lock");
    }
    ...
    public void play(QueueItem item) {
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            // with regards to AudioFocus. All of feelthetour's tracks are music, but
            ...
            DataSource.Factory dataSourceFactory =
                    new DefaultDataSourceFactory(
                            mContext, Util.getUserAgent(mContext, "feelthetour"), null);
