...
import com.example.android.feelthetour.AlbumArtCache;
...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPauseDrawable = ContextCompat.getDrawable(this, R.drawable.feelthetour_ic_pause_white_48dp);
        mPlayDrawable = ContextCompat.getDrawable(this, R.drawable.feelthetour_ic_play_arrow_white_48dp);
    ...
    private void updateFromParams(Intent intent) {
        if (intent != null) {
            MediaDescriptionCompat description = intent.getParcelableExtra(
                WelcomeActivity.EXTRA_CURRENT_MEDIA_DESCRIPTION);
            if (description != null) {
