...
public class BitmapHelper {
    private static final String TAG = com.example.android.feelthetour.utils.LogHelper.makeLogTag(BitmapHelper.class);
    ...
    public static Bitmap fetchAndRescaleBitmap(String uri, int width, int height)
        ...
        try {
            ...
            com.example.android.feelthetour.utils.LogHelper.d(TAG, "Scaling bitmap ", uri, " by factor ", scaleFactor, " to support ",
